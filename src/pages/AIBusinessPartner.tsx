...
import { ArrowRight, Download, BookOpen, Check, X, MessageSquare, BarChart3, Zap, Bot, Rocket, Award, ExternalLink, ChevronRight } from "lucide-react";
...
export default function AIBusinessPartner() {
  ...
  const CounterAnimation = ({
    ...
    return <div ref={counterRef} className="text-center">
        <p className="text-4xl md:text-5xl font-bold text-primary mb-2">{count}+</p>
        <p className="text-gray-600">{label}</p>
      </div>;
  };
  return <div className="min-h-screen bg-gradient-to-b from-slate-900 via-indigo-900/20 to-slate-900 text-white">
      <SEO title="AI Business Partner Model - Scale Your Business With AI" description="New book reveals how business owners can partner with AI experts to scale effortlessly and unlock $100k+ revenue streams without becoming a tech guru." path="/ai-business-partner" />
      ...
      <div ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <img src="/lovable-uploads/cd3826ee-3df6-4947-b0b1-a5ff9f03f4cb.png" alt="AI Business Partner" className="w-full h-full object-cover" />
        </div>
        ...
        scale
          ...
          <div className="max-w-4xl mx-auto text-center mb-8">
            <div className="inline-block px-4 py-1 bg-indigo-600 rounded-full text-sm font-medium mb-4">INTRODUCING THE AI BUSINESS MANAGER MODEL</div>
            ...
            <Card className="bg-indigo-800/50 border-indigo-700 mb-12 backdrop-blur-sm">
              <CardContent className="p-6">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">The AI Business Manager Model Is The Key To Sustainable Growth Without Hiring More Staff Or Burning Out</h3>
              </CardContent>
            </Card>
            ...
            damping: 10
              ...
              <Button size="lg" className="text-lg px-6 py-3 md:px-8 md:py-6 h-auto rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 shadow-lg hover:shadow-indigo-500/50 transition-all duration-300" onClick={handlePurchase}>
        ...
        {showScrollCTA && <motion.div initial={{
        opacity: 0,
        y: 50
      }} animate={{
        opacity: 1,
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-indigo-900/30">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Before We Introduced The AI Business Manager Model...</h2>
      ...
      <section ref={featureRef} className="py-20 bg-indigo-900/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Introducing The AI Business Manager Model</h2>
          ...
          <div className="mt-20">
            <h3 className="text-2xl md:text-3xl font-bold text-white text-center mb-12">How The AI Business Manager Model Works</h3>
      ...
      <section className="py-20 bg-indigo-900/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              To show you exactly how this works, we put everything into a <span className="font-bold text-indigo-950">$14.40 guide</span> called:
            </p>
            
            <Card className="bg-indigo-800/50 border-indigo-700 mt-8 mb-12 backdrop-blur-sm max-w-3xl mx-auto">
              <CardContent className="p-6">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 italic">The AI Business Manager: How We Help Business Owners Unlock $100,000+ In Revenue While AI Handles The Work</h3>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            once: true
              ...
              <div className="space-y-4">
                {["How to turn AI into your biggest competitive advantage", "The 3-step system to automating sales and customer engagement", "How to scale to 7 figures without hiring more staff", "How we structure performance-based partnerships that align with your growth", "Why traditional marketing agencies are failing, and how AI changes the game"].map((item, index) => <div key={index} className="flex items-start">
              ...
              <div className="pt-8">
                ...
                }].map((bonus, index) => <div key={index} className="flex items-start">
                      <Check className="mr-3 h-6 w-6 text-green-400 flex-shrink-0 mt-1" />
                      <div>
            ...
            once: true
              ...
              <div className="relative max-w-md">
                ...
                <div className="relative bg-slate-800 p-8 rounded-xl shadow-xl border border-indigo-500/30">
                  ...
                  {["Business Optimization Dashboard", "AI Sales Assistant", "Revenue Expansion Strategies", "Compliance & Integration Training", "42 Profitable AI Niches Guide"].map((item, index) => <div key={index} className="flex justify-between items-center mb-4 pb-4 border-b border-indigo-500/30">
                  ...
                  damping: 10
                    ...
                    <Button size="lg" className="w-full text-lg py-6 h-auto rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 shadow-lg hover:shadow-indigo-500/50 transition-all duration-300" onClick={handlePurchase}>
                      <Download className="mr-2 h-5 w-5" />
      ...
      <section className="py-20 bg-indigo-900/20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            answer: "The book covers 42 profitable niches that are ideal for AI implementation, but generally speaking, if your business involves customer communication, appointment scheduling, sales processes, content creation, or data analysis, it's likely a good fit. The book will help you determine exactly how the model applies to your specific industry."
          }].map((faq, index) => <Dialog key={index}>
                ...
                <DialogContent className="bg-slate-800 text-white border-indigo-500">
                  ...
                  <DialogFooter>
                    <Button onClick={handlePurchase} className="bg-indigo-600 hover:bg-indigo-500 text-white">
                      Get The Book Now
                    </Button>
                  </DialogFooter>
                </DialogContent>
              ...
              <DialogContent className="bg-slate-800 text-white border-indigo-500">
                ...
                <form onSubmit={handleSubmitQuestion} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="email" type="email" className="bg-slate-700 border-slate-600 text-white" placeholder="you@example.com" required />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="question" className="text-sm font-medium text-white">
                      Your Question
                    </label>
                    <Textarea id="question" className="bg-slate-700 border-slate-600 text-white min-h-[100px]" placeholder="What would you like to know about the AI Business Partner model?" value={message} onChange={e => setMessage(e.target.value)} required />
                  </div>
                  <DialogFooter>
            ...
            <Card className="bg-slate-800/70 border-indigo-500/30">
              <CardContent className="p-6 md:p-8">
                ...
                <form onSubmit={handleLeadCapture} className="space-y-4">
                  <Input type="email" placeholder="Your email address" className="bg-slate-700 border-slate-600 text-white" value={email} onChange={e => setEmail(e.target.value)} required />
      ...
      {/* Chat Widget */}
      {showChat && <div ref={chatRef} className={`fixed ${chatMinimized ? 'bottom-6 right-6 w-auto h-auto' : 'bottom-6 right-6 w-80 md:w-96'} bg-slate-800 rounded-xl shadow-2xl border border-indigo-500/30 z-50 transition-all duration-300`}>
          {chatMinimized ? <div className="p-4 cursor-pointer flex items-center space-x-2" onClick={() => setChatMinimized(false)}>
              <MessageSquare className="h-6 w-6 text-indigo-400" />
              <span className="text-white font-medium">Chat with us</span>
            </div> : <div className="flex flex-col h-96">
              <div className="flex items-center justify-between bg-indigo-900/50 p-4 rounded-t-xl">
                ...
                <button onClick={() => setChatMinimized(true)} className="text-white/70 hover:text-white">
                  <X className="h-5 w-5" />
                </button>
              </div>
              ...
              <div className="flex-1 p-4 overflow-y-auto bg-slate-900 space-y-4">
                ...
                <div className="bg-indigo-900/30 p-3 rounded-lg max-w-[80%]">
                  ...
                  <div className="mt-2 space-y-2">
                    <Button variant="outline" size="sm" className="w-full justify-start border-indigo-500/50 text-white text-sm hover:bg-indigo-900/50" onClick={() => toast({
                ...
                description: "We've sent our best case studies to your email."
                    ...
                    <Button variant="outline" size="sm" className="w-full justify-start border-indigo-500/50 text-white text-sm hover:bg-indigo-900/50" onClick={handlePurchase}>
                      Get the book now
                    </Button>
                  </div>
                </div>
              ...
              <div className="p-3 border-t border-indigo-500/30 bg-slate-800 rounded-b-xl">
                <form className="flex space-x-2">
                  <Input placeholder="Type your question here..." className="flex-1 bg-slate-700 border-slate-600 text-white text-sm" />
                  <Button size="sm" className="bg-indigo-600 hover:bg-indigo-500 text-white" onClick={() => toast({
              title: "Message Sent",
