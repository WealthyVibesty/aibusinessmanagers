          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-6">
              ...
              <p className="text-gray-600">
                Our AI answers calls instantly, reducing wait times by 80%, and handles scheduling, billing, and questions.
              </p>
            </Card>
            <Card className="p-6">
            ...
            <Card className="p-6">
              ...
              <p className="text-gray-600">
                Replace expensive call handling with AI that reduces costs by up to 70%, saving thousands monthly.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <Card className="p-8 bg-primary text-white">
            ...
            <p className="text-xl mb-8 opacity-90">Join leading healthcare institutions using AI to improve efficiency by up to 70%</p>
            <Button 
              size="lg" 
              variant="secondary"
              onClick={() => navigate("/checkout")}
