...
export default function PricingDetailsSection() {
  ...
  return (
    <section className="bg-gradient-to-b from-background to-secondary/10 py-4 sm:py-16">
        ...
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-12">
          ...
          <div className="grid gap-3 sm:gap-8">
            {offerings.map((offering, i) => (
              <Card 
                key={i} 
                className="p-3 sm:p-6 animate-slideUp"
            ...
            <div className="space-y-3 sm:space-y-4">
              {bonuses.map((bonus, i) => (
                <Card 
                  key={i} 
                  className="p-3 sm:p-6 border-primary/20 animate-slideUp"
                  style={{ animationDelay: `${(offerings.length + i) * 100}ms` }}
                >
                  <h3 className="text-base sm:text-xl font-semibold mb-1 sm:mb-2">
                    Bonus #{i + 1}: {bonus.title}
                  </h3>
                  <p className="text-muted-foreground mb-1 sm:mb-2 text-sm">
            ...
            <Card className="p-4 sm:p-8 border-2 border-primary animate-fadeIn mt-3 sm:mt-4" style={{ animationDelay: "800ms" }}>
              <div className="text-center space-y-4 sm:space-y-5">
                <div className="space-y-1 sm:space-y-2">
                  <p className="text-lg sm:text-2xl font-bold">Total Value: $2,500+</p>
                ...
                <div className="max-w-2xl mx-auto space-y-3 sm:space-y-4">
                  <h3 className="text-base sm:text-xl font-semibold">Why This Deal is Unbeatable:</h3>
                ...
                <div className="pt-3 sm:pt-4">
                  <h3 className="text-base sm:text-xl font-semibold mb-2 sm:mb-3">Limited-Time Offer: Act Now!</h3>
            ...
            <div className="text-center space-y-4 sm:space-y-5 animate-fadeIn py-3 sm:py-4" style={{ animationDelay: "900ms" }}>
              <div>
                <h3 className="text-base sm:text-xl font-semibold mb-1 sm:mb-2">Got Questions?</h3>
