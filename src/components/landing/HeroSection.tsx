...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-12 min-h-[60vh] flex flex-col items-center justify-start px-4 sm:px-6 lg:px-8 overflow-hidden bg-white/90 backdrop-blur-md text-center">
      ...
      <div className="max-w-4xl mx-auto space-y-8 sm:space-y-10">
        ...
        <div className="flex justify-center px-4">
          <Button
            size="lg"
            className="mt-8 sm:mt-12 text-lg sm:text-xl group animate-slideUp"
